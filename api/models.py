...
class VideoTranscript:
    ...
    openai_cost: Optional[float] = None  # Cost in USD for OpenAI STT if used
    audio_duration_minutes: Optional[float] = None  # Audio duration for cost calculation
...
class ProcessingResult:
    ...
    gemini_input_tokens: Optional[int] = None  # Total input tokens used by Gemini
    gemini_output_tokens: Optional[int] = None  # Total output tokens generated by Gemini
    gemini_cost: Optional[float] = None  # Cost in USD for Gemini processing
